...
class ChangeModel(models.Model):
    method2=models.CharField(blank=True,max_length=20,choices=[("All upper","All upper"),("All lower","All lower"),("Capitalize first only","Capitalize first only")])
    input=models.TextField(blank=True)
    output=models.TextField(blank=True)

class FindModel(models.Model):
    method3=models.CharField(blank=True,max_length=20,choices=[('Case Sensitive','Case Sensitive'),('Case invariant','Case invariant')])
